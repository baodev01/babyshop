...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 24, 2018 at 04:04 PM
...
INSERT INTO `tb_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2018-01-24 21:40:32', '2018-01-24 21:40:32');

-- --------------------------------------------------------

--
-- Table structure for table `tb_api_ip`
--

CREATE TABLE IF NOT EXISTS `tb_api_ip` (
...
--
-- Table structure for table `tb_api_session`
--

CREATE TABLE IF NOT EXISTS `tb_api_session` (
...
INSERT INTO `tb_banner` (`banner_id`, `name`, `status`) VALUES
(6, 'HP Products', 1),
...
INSERT INTO `tb_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
...
(2, 'US Dollar', 'USD', '$', '', '2', 1.00000000, 1, '2018-01-24 15:01:54'),
...
--
-- Table structure for table `tb_customer_affiliate`
--

CREATE TABLE IF NOT EXISTS `tb_customer_affiliate` (
  `customer_id` int(11) NOT NULL,
  `company` varchar(40) NOT NULL,
...
--
-- Table structure for table `tb_customer_approval`
--

CREATE TABLE IF NOT EXISTS `tb_customer_approval` (
...
--
-- Table structure for table `tb_customer_search`
--

CREATE TABLE IF NOT EXISTS `tb_customer_search` (
...
--
-- Table structure for table `tb_customer_wishlist`
--
...
INSERT INTO `tb_event` (`event_id`, `code`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `tb_extension_install`
--

CREATE TABLE IF NOT EXISTS `tb_extension_install` (
...
--
-- Table structure for table `tb_extension_path`
--

CREATE TABLE IF NOT EXISTS `tb_extension_path` (
...
INSERT INTO `tb_geo_zone` (`geo_zone_id`, `name`, `description`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `tb_order_shipment`
--

CREATE TABLE IF NOT EXISTS `tb_order_shipment` (
...
INSERT INTO `tb_order_status` (`order_status_id`, `language_id`, `name`) VALUES
(2, 1, 'Processing'),
(3, 1, 'Shipped'),
(7, 1, 'Canceled'),
(5, 1, 'Complete'),
...
INSERT INTO `tb_product_attribute` (`product_id`, `attribute_id`, `language_id`, `text`) VALUES
(43, 2, 1, '1'),
(47, 4, 1, '16GB'),
(43, 4, 1, '8gb'),
(42, 3, 1, '100mhz'),
...
--
-- Dumping data for table `tb_product_discount`
--

INSERT INTO `tb_product_discount` (`product_discount_id`, `product_id`, `customer_group_id`, `quantity`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
INSERT INTO `tb_product_image` (`product_image_id`, `product_id`, `image`, `sort_order`) VALUES
...
--
-- Dumping data for table `tb_product_special`
--

INSERT INTO `tb_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
...
--
-- Table structure for table `tb_seo_url`
--

CREATE TABLE IF NOT EXISTS `tb_seo_url` (
...
--
-- Dumping data for table `tb_seo_url`
--

INSERT INTO `tb_seo_url` (`seo_url_id`, `store_id`, `language_id`, `query`, `keyword`) VALUES
...
INSERT INTO `tb_session` (`session_id`, `data`, `expire`) VALUES
('73f6b8c7726e9048739354c556', '{"user_id":"1","user_token":"fldKQ7KSyM9C5Lh20cD2JCRI0iXIUVsa","language":"en-gb","currency":"USD"}', '2018-01-24 15:25:55');
...
(201, 0, 'config', 'config_email', 'baodev01@gmail.com', 0),
...
(202, 0, 'config', 'config_encryption', '', 0),
...
--
-- Table structure for table `tb_shipping_courier`
--

CREATE TABLE IF NOT EXISTS `tb_shipping_courier` (
...
--
-- Dumping data for table `tb_shipping_courier`
--

INSERT INTO `tb_shipping_courier` (`shipping_courier_id`, `shipping_courier_code`, `shipping_courier_name`) VALUES
(1, 'dhl', 'DHL'),
(2, 'fedex', 'Fedex'),
(3, 'ups', 'UPS'),
...
INSERT INTO `tb_statistics` (`statistics_id`, `code`, `value`) VALUES
(1, 'order_sale', '0.0000'),
...
(1, 1, 'admin', '3c3eb15ecc804f90c958ea48d2a4433c81b4f173', 'JRaJEltG4', 'Bao', 'Nguyen', 'baodev01@gmail.com', '', '', '::1', 1, '2018-01-24 21:40:32');
...
--
-- Indexes for table `tb_api_ip`
--
ALTER TABLE `tb_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indexes for table `tb_api_session`
--
ALTER TABLE `tb_api_session`
...
--
-- Indexes for table `tb_customer_affiliate`
--
ALTER TABLE `tb_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indexes for table `tb_customer_approval`
--
ALTER TABLE `tb_customer_approval`
...
--
-- Indexes for table `tb_customer_search`
--
ALTER TABLE `tb_customer_search`
...
--
-- Indexes for table `tb_customer_wishlist`
--
ALTER TABLE `tb_customer_wishlist`
...
--
-- Indexes for table `tb_extension_install`
--
ALTER TABLE `tb_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indexes for table `tb_extension_path`
--
ALTER TABLE `tb_extension_path`
...
--
-- Indexes for table `tb_order_shipment`
--
ALTER TABLE `tb_order_shipment`
...
--
-- Indexes for table `tb_seo_url`
--
ALTER TABLE `tb_seo_url`
  ADD PRIMARY KEY (`seo_url_id`), ADD KEY `query` (`query`), ADD KEY `keyword` (`keyword`);
...
--
-- Indexes for table `tb_shipping_courier`
--
ALTER TABLE `tb_shipping_courier`
  ADD PRIMARY KEY (`shipping_courier_id`);

--
-- Indexes for table `tb_statistics`
--
...
--
-- Indexes for table `tb_translation`
--
...
--
-- AUTO_INCREMENT for table `tb_api_ip`
--
ALTER TABLE `tb_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_api_session`
--
ALTER TABLE `tb_api_session`
...
--
-- AUTO_INCREMENT for table `tb_customer_approval`
--
ALTER TABLE `tb_customer_approval`
...
--
-- AUTO_INCREMENT for table `tb_customer_search`
--
ALTER TABLE `tb_customer_search`
...
--
-- AUTO_INCREMENT for table `tb_extension_install`
--
ALTER TABLE `tb_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `tb_extension_path`
--
ALTER TABLE `tb_extension_path`
...
--
-- AUTO_INCREMENT for table `tb_order_shipment`
--
ALTER TABLE `tb_order_shipment`
...
--
-- AUTO_INCREMENT for table `tb_seo_url`
--
ALTER TABLE `tb_seo_url`
...
--
-- AUTO_INCREMENT for table `tb_statistics`
--
ALTER TABLE `tb_statistics`
...
--
-- AUTO_INCREMENT for table `tb_translation`
--
ALTER TABLE `tb_translation`
